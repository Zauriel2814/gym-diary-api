...
/*
    In this bootstrap, we are going to create sample data for the lesson. 
    In the real world, you may use bootstrap to mock data for development. 
...
(async ()=>{
    ...
    // Create users
    const user1 = new User({ uid: USER_1_UID, email: `${USER_1_UID}@example.com` });
    await user1.save();
    const user2 = new User({ uid: USER_2_UID, email: `${USER_2_UID}@example.com` });
    await user2.save();
